...
export default () => (
  <div className="min-w-screen min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-200 to-purple-400 p-5">
    <div className="bg-gradient-to-br from-white/40 to-white/50 border border-white/50 p-[8px] rounded-[20px] backdrop-blur shadow-[0_20px_280px_rgba(0,0,0,0.2)]">
      <div className="bg-white rounded-[12px] p-8 md:p-20 shadow-[0_0_12px_rgba(0,0,0,0.2)]">
        ...
        <ul className="list-disc list-inside opacity-70 space-y-1">
          <li>Clone this repo or use as template</li>
          <li>
            Get started by editing{" "}
            <span className={pt_mono.className}>`src/app/page.js`</span>
          </li>
          <li>
            All the UI components are at{" "}
            <span className={pt_mono.className}>`ui/index.js`</span>
          </li>
        </ul>
      </div>
